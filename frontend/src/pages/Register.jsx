        ...
        <div className="min-h-screen flex flex-col bg-background-light dark:bg-background-dark text-[#1b120e] dark:text-[#fcf9f8] overflow-hidden relative pb-20 max-w-[430px] mx-auto">
            ...
            >
                <motion.div className="text-center mb-8" variants={itemVariants}>
                    ...
                    <p className="text-warm-beige dark:text-warm-beige/80 text-sm mt-1.5">加入 PawMate 大家庭</p>
                </motion.div>
                ...
                >
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="space-y-2">
                            <label htmlFor="register-email" className="text-sm font-medium text-[#1b120e]/80 dark:text-[#fcf9f8]/80 block ml-0.5">
                                邮箱 / 账号
                            </label>
                            <input
                                id="register-email"
                        ...
                        <div className="space-y-2">
                            <label htmlFor="register-password" className="text-sm font-medium text-[#1b120e]/80 dark:text-[#fcf9f8]/80 block ml-0.5">
                                设置密码
                            </label>
                            <input
