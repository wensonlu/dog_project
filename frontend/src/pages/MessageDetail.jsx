...
const MessageDetail = () => {
    ...
    if (!message) {
        return (
            <div className="max-w-[430px] mx-auto min-h-screen flex flex-col bg-background-light dark:bg-background-dark pb-24">
                <header className="sticky top-0 ios-safe-top z-50 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-md px-6 pt-6 pb-4">
                    <button
                        type="button"
    ...
    return (
        <div className="max-w-[430px] mx-auto min-h-screen flex flex-col bg-background-light dark:bg-background-dark pb-24">
            <header className="sticky top-0 ios-safe-top z-50 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-md px-6 pt-6 pb-4 border-b border-[#F0E6DD] dark:border-zinc-700">
