...
```
git commit --message "Implement feature" --trailer "Assistant-model: Codex"
```
...
```
2100e6c Author [Codex] Test commit 4 (HEAD -> work-item-8)
7120221 Author [Codex] Test commit 3
ea03d91 Author [] Test commit 2
f93fd8e Author [Codex] Test commit 1
dde0159 Codex [] Test work item (#7) (origin/main, origin/HEAD)
```
